 ...
 <main id="main">
 			...
 			<div class="row content">
 				...
 				<div class="col-lg-6 pt-4 pt-lg-0 text-justify" data-aos="fade-left">
 					<p>
 						...
 						contribution in the field of law academic by conducting a variety of events
 						that have a strong quality yet influences law student to achieve their goals.
 					</p>

 					<p>
 						CLA is a series of webinar classes featuring alumni of Atma Jaya Faculty of
 						Law across generation as speakers of this series. CLA aims to equip both Atma Jaya
 						students and external students with the fundamental knowledge of business law along
 						with its practical implementation. By joining CLA, you will get insights from the
 						top speakers who are distinguished business law expertise.
 					</p>
 					<p>
 						This is a non-profit event, whereby any attendance fee from external will be donated
 						as charity for people who are affected during the Covid-19.</p>
 				</div>
 			</div>
 		</div>
 	</section>
 	...
 	<section id="team" class="team section-bg">
 		<div class="container">
 			...
 			<div id="speaker" class="row carousel slide" data-ride="carousel" data-aos="fade-left">
 				...
 				<a class="carousel-control-prev" href="#speaker" role="button" data-slide="prev">
 					<span class="carousel-control-prev-icon icofont-simple-left" aria-hidden="true"></span>
 					<span class="sr-only">Previous</span>
 				</a>
 				<a class="carousel-control-next" href="#speaker" role="button" data-slide="next">
 	...
 	<section id="session" class="blog-area pt-170 pb-140">
 		<div class="container" data-aos="fade-up">
 			<div class="section-title mt-5" data-aos="fade-up">
 				<h2><strong>This Year's Topics</strong></h2>
 			</div>
	 ...
	 <section id="portfolio" class="portfolio">
		<div class="container">
			...
			<div class="row d-flex justify-content-center mx-md-n5">
				<a href="https://www.instagram.com/corplegalacademy/" class="instagram px-md-5" title="Instagram"><i class="icofont-instagram icofont-2x"></i></a>
				<a href="https://www.linkedin.com/company/corporate-legal-academy/mycompany/" class="linkedin px-md-5" title="Linkedin"><i class="icofont-linkedin icofont-2x"></i></a>
				<!-- <a href="#" class="facebook px-md-5" title="Facebook"><i class="icofont-facebook icofont-2x"></i></a> -->
				<a href="mailto:corplegalacademy@gmail.com" class="message px-md-5" title="Message"><i class="icofont-ui-message icofont-2x"></i></a>
