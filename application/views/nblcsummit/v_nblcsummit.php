...
<section id="hero">
	<div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="carousel-item active" style="background-image: url(assets/img/abls/banner/nblc_summit_banner.png);">
				<div class="hero-taxt">
		...
		<div class="container">
			...
			<div class="row portfolio-container" data-aos="fade-up">
				...
				<div class="col-lg-4 col-md-6 portfolio-item filter">
					<a href="<?= base_url('assets/img/abls/nblc/1.png') ?>" data-gall="portfolioGallery" class="venobox preview-link">
						<img src="<?= base_url('assets/img/abls/nblc/1.png') ?>" class="img-fluid" alt=""></a>
				</div>
