...
<section id="hero">
	<div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="carousel-item active" style="background-image: url(assets/img/abls/cla/panitia.jpg); width:1550px;height:950px;">
			</div>
		</div>
	</div>
</section>
...
<main id="main">
    ...
    <section id="team" class="team section-bg">
     ...
     <div class="section-title mt-5" data-aos="fade-up">
          ...
          <h2>3. Problem of Suspension of Debt Payment Obligation</h2><h2>
...
for</h2><h2>the Settlement of Trade Disputes</h2><br>
          ...
          <h2>14. Legal Aspect of Mandatory Covertible Bond as Restructuring</h2><h2>Mechanism in Public Company</h2><br>
